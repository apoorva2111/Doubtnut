...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Apxor-CE/APXContextEvaluator.framework"
  install_framework "${PODS_ROOT}/Apxor-Core/ApxorSDK.framework"
  install_framework "${PODS_ROOT}/Apxor-RTA/APXRTAPlugin.framework"
  install_framework "${PODS_ROOT}/Apxor-Survey/APXSurveyPlugin.framework"
  install_framework "${PODS_ROOT}/Apxor-WYSIWYG/APXWYSIWYGPlugin.framework"
